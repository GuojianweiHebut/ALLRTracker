...
%  This code is built upon SAMF:
%  A Scale Adaptive Kernel Correlation Filter Tracker with Feature Integration (SAMF)
%  Yang Li,Jianke Zhu


%  >> get_learning_rate.m is the implement of Adaptive Learning Rate
%  >> get_features.m optimizes the feature extraction process
%  >> tracker.m,use a new long time tracker refine_alphaf to collaborate 
%     with the short time tracker.
%  revised by: Jianwei Guo, June, 2017
